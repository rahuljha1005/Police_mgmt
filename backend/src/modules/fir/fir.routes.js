...
router.get("/", requireRoles("ADMIN", "SP", "INSPECTOR", "CONSTABLE"), firController.getFirs);
router.get("/:id", requireRoles("ADMIN", "SP", "INSPECTOR", "CONSTABLE"), firController.getFirById);
